...
If you check [Palo Alto's documentation on this](https://knowledgebase.paloaltonetworks.com/KCSArticleDetail?id=kA10g000000ClgECAS), it will tell you that the IPSec tunnel status is monitored only via SNMP traps and not queries.
...
You can find and download [the script on GitHub](https://github.com/LuizMeier/Zabbix/blob/master/Palo%20Alto/IPSec_EN.py). Below are examples of how to use it:
