...
![JSON validator](/assets/img/zabbix-custom-lld/validador-json.png)
*JSON output*
...
To test that, run the below command in a command prompt.
...
![Discovery rule](/assets/img/zabbix-custom-lld/regra-descoberta.png)
*Discovery rule*
