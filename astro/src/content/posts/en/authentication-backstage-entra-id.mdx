...
For this tutorial, we will **manually create a user** in the catalog. However, you can automate user ingestion via **Microsoft Graph** (check the [Microsoft Graph integration documentation](https://backstage.io/docs/integrations/azure/org/)).
